...
export default function NewsCard({ news, index }: NewsCardProps) {
  return (
    <Card className="border border-gray-100 hover:border-[#6C63FF]/20 transition-colors">
      <CardContent className="p-6">
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#F4F3FF] flex items-center justify-center">
            ...
            <div className="flex items-center gap-2 text-xs text-[#4A4A6A]/70 pt-1">
              ...
              {news.url && (
                <a
                  ...
                  className="inline-flex items-center gap-1 text-[#6C63FF] hover:underline"
                >
